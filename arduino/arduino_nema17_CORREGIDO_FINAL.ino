/*
 * ARDUINO NEMA17 CONTROLLER - VERSIÓN CORREGIDA FINAL
...
void moveToPosition(float degrees, int dwellTimeValue) {
  ...
  // CORREGIDO: Calcular pasos correctamente
  int targetSteps = (int)(degrees * STEPS_PER_REVOLUTION / 360.0);
...
void moveStepper() {
  ...
  if (currentTime - lastStepTime >= STEP_DELAY) {
    if (currentPosition != targetPosition) {
      ...
      isMoving = false;
      float currentDegrees = currentPosition * 360.0 / STEPS_PER_REVOLUTION;
